    ...
    <BackgroundBeamsWithCollision>
      <section className="w-full max-w-xl mx-auto py-16 flex flex-col items-center gap-8">
        ...
        <div className="text-center px-2 md:px-0">
          <h2 className="text-3xl md:text-5xl font-bold mb-2 text-white md:whitespace-nowrap">
        ...
        {/* Form wrapper for responsive margin */}
        <div className="w-full max-w-xs sm:max-w-md md:max-w-xl mx-2 md:mx-auto">
          <form
            ref={formRef}
